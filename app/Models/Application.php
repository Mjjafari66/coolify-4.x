...
class Application extends BaseModel
{
    ...
    public function traefikSslCertificates(): MorphMany
    {
        return $this->morphMany(SslCertificate::class, 'resource')->applicationTraefik();
    }
    ...
    public function traefikSslCertificateForDomain(string $domain): ?SslCertificate
    {
        return $this->traefikSslCertificates()
            ->where('domain', $domain)
            ->first();
