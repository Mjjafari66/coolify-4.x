...
class CleanupDocker
{
    ...
    public function handle(Server $server, bool $deleteUnusedVolumes = false, bool $deleteUnusedNetworks = false)
    {
        ...
        $realtimeImageWithVersion = coolifyImageWithVersion($realtimeImage, $realtimeImageVersion);
        ...
        $helperImageWithVersion = coolifyImageWithVersion($helperImage, $helperImageVersion);
