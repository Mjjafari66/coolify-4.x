...
use App\Livewire\Server\Proxy\SslSettings as ProxySslSettings;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('project/{project_uuid}/environment/{environment_uuid}/application/{application_uuid}')->group(function () {
        ...
        Route::get('/ssl', ApplicationConfiguration::class)->name('project.application.ssl');
    ...
    Route::prefix('server/{server_uuid}')->group(function () {
        ...
        Route::get('/proxy/ssl', ProxySslSettings::class)->name('server.proxy.ssl');
