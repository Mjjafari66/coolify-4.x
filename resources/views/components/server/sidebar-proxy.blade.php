<div class="sub-menu-wrapper">
    ...
    @if ($server->proxySet())
        <a class="{{ request()->routeIs('server.proxy.ssl') ? 'sub-menu-item menu-item-active' : 'sub-menu-item' }}" {{ wireNavigate() }}
            href="{{ route('server.proxy.ssl', $parameters) }}">
            <span class="menu-item-label">SSL</span>
        </a>
